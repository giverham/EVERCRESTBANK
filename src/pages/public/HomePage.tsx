...
export function HomePage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative bg-primary-950 pt-24 pb-12 md:pt-32 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-900/30 via-primary-950 to-primary-950 opacity-50" />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-secondary-200 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
